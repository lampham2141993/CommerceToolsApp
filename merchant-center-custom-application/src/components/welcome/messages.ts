...
export default defineMessages({
  ...
  cardProductLabelsTitle: {
    id: 'Welcome.cardProductLabelsTitle',
    defaultMessage: 'Product labels',
  },
  cardProductLabelsContent: {
    id: 'Welcome.cardProductLabelsContent',
    defaultMessage:
      'Create and manage product labels with schedule, image, and product assignments.',
  },
});
